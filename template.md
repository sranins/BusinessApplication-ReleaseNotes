...
- **Required metadata**
    ...
    - **description** - This is the full description that appears in the search results. This should not be the first paragraph of your topic, although it may be similar.
    - **author** - This is your GitHub alias, which is required for ownership and sorting in GitHub.
    - **manager** - Use the manager of the doc team for your organization in this field.
    - **ms.date** - This should be the first proposed publication date.
    - **ms.topic** - Enter "article" here.
    - **ms.prod** 
    - **ms.service** - Always use "business-applicatins".
    - **ms.technology** 
