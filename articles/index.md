...
> [!TIP]
> Looking for a PDF instead? The PDF version is updated once a month with the latest content. [Download the Spring '18 release notes PDF](https://aka.ms/dynamics365releasenotes). To find out when there are updates to the PDF, follow us on Twitter @MSFTDynamics365.
